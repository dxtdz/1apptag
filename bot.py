...
async def danhsachtask(ctx):
    ...
    def create_embed(page):
        ...
        description = "\n".join(page_tasks) + "\𝑻𝒓𝒂𝒏 𝑯𝒐𝒂𝒏𝒈 𝑫𝒖𝒚 "
        embed = discord.Embed(
...
async def listbox(ctx):
    ...
    embed.set_footer(text="𝑻𝒓𝒂𝒏 𝑯𝒐𝒂𝒏𝒈 𝑫𝒖𝒚 ", icon_url=bot.user.avatar.url if bot.user.avatar else None)
...
async def delete(ctx, user: discord.User):
    if user is None:
        await ctx.send("Format: `delete @user`")
        return
 ...
 #thay link gif vào
gif_links = [
    "https://files.catbox.moe/3gi82u.gif",
    "https://files.catbox.moe/jtidxv.gif",
    "https://files.catbox.moe/a1w7p7.gif"
]
...
async def menu(ctx):
    embed = discord.Embed(
        title="📜・𝐌𝐄𝐍𝐔 𝐁𝐎𝐓 ",
        description="🧃 XuanThang 🇻🇳\n",
        color=discord.Colour.from_rgb(0, 255, 255)
    )
    embed.add_field(
        name="👑・XuanThang",
        value="🤹 **`!𝐚𝐝𝐝𝐭𝐚𝐬𝐤`** — 𝐀𝐝𝐝 𝐓𝐚𝐬𝐤\n"
             "🚮 **`!𝐫𝐞𝐦𝐨𝐯𝐞𝐭𝐚𝐬𝐤`** - 𝐃𝐞𝐥𝐞𝐭𝐞 𝐓𝐚𝐬𝐤\n",
        inline=False
    )
    embed.add_field(
        name="💻・𝐌𝐞𝐬𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬",
        value=(
            "🍂 **`!𝐦𝐞𝐧𝐮`** — 𝐗𝐞𝐦 𝐌𝐞𝐧𝐮 𝐂𝐡𝐢́𝐧𝐡\n"
            "🍂 **`!𝐭𝐫𝐞𝐨`** — 𝐓𝐫𝐞𝐨 𝐌𝐞𝐬𝐬 & 𝟑 𝐂𝐧𝐚𝐧𝐠\n"
            "🍂 **`!𝐧𝐡𝐚𝐲`** — 𝐍𝐡𝐚̂𝐲/𝐍𝐡𝐚̂𝐲 𝐓𝐚𝐠 & 𝐅𝐚𝐤𝐞 𝐒𝐨𝐚̣𝐧\n"
            "🍂 **`!𝐧𝐡𝐚𝐲𝐭𝐨𝐩`** — 𝐍𝐡𝐚̂𝐲 𝐓𝐨𝐩 𝐓𝐚𝐠 𝐏𝐨𝐬𝐭 𝐆𝐫𝐨𝐮𝐩\n"
            "🍂 **`!𝐭𝐫𝐞𝐨𝐬𝐨`** — 𝐓𝐫𝐞𝐨 𝐒𝐨̛́ & 𝐅𝐚𝐤𝐞 𝐒𝐨𝐚̣𝐧\n"
            "🍂 **`!𝐝𝐚𝐧𝐡𝐬𝐚𝐜𝐡𝐭𝐚𝐬𝐤`** — 𝐃𝐚𝐧𝐡 𝐒𝐚́𝐜𝐡 𝐓𝐚𝐬𝐤\n"
            "🍂 **`!𝐧𝐡𝐚𝐲𝐩𝐨𝐥𝐥`** — 𝐍𝐡𝐚̂𝐲 𝐏𝐨𝐥𝐥 𝐌𝐞𝐬𝐬\n"
            "🍂 **`!𝐥𝐢𝐬𝐭𝐛𝐨𝐱`** - 𝐗𝐞𝐦 𝐃𝐚𝐧𝐡 𝐒𝐚́𝐜𝐡 𝐁𝐨𝐱\n"
            "🍂 **`!𝐦𝐞𝐭𝐚`** — 𝐇𝐨̉𝐢 𝐌𝐞𝐭𝐚 𝐀𝐈\n"
            "🍂 **`!𝐧𝐡𝐚𝐲𝐧𝐚𝐦𝐞𝐛𝐨𝐱`** — 𝐍𝐡𝐚̂𝐲 𝐍𝐚𝐦𝐞 𝐁𝐨𝐱\n\n"
        ),
        inline=False
    )
    embed.add_field(
        name="🌐・𝐆𝐥𝐨𝐛𝐚𝐥𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬",
        value="🍂 **`!𝐬𝐭𝐨𝐩𝐭𝐚𝐬𝐤`** — 𝐒𝐭𝐨𝐩 𝐓𝐚𝐬𝐤 𝐓𝐡𝐞𝐨 𝐈𝐃 𝐓𝐚𝐬𝐤𝐬",
        inline=False
    )

    embed.set_footer(text="Dinh Xuan Thang")
